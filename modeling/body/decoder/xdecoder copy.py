...
#from .modules import SelfAttentionLayer, CrossAttentionLayer, FFNLayer, MLP Z comment this out 
from .modules import SelfAttentionLayer, CrossAttentionLayer, GatedAttentionUnit, MLP # Z added this
        ...
        if task == 'vlp':
            ...
            out = {
                ...
                'aux_outputs': self._set_aux_loss(
                    predictions_class if self.mask_classification else None, predictions_mask, predictions_bbox, predictions_caption Z comment this out
                )
            }
            return out
